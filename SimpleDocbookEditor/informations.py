...
APPNAME = "Simple DocBook Editor"
UNIX_APPNAME = "simple-docbook-editor"
VERSION = "0.1"
APP_DESCRIPTION = "Simple DocBook Editor"
AUTHORS = [
    {"name": "Gwendal Le Bihan", "email": "gwendal.lebihan.dev@gmail.com"}
]
LICENSE = """Simple DocBook Editor is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.
...
You should have received a copy of the GNU General Public License
along with Simple DocBook Editor.  If not, see <http://www.gnu.org/licenses/>."""
COPYRIGHT_NOTICE = "Copyright © 2014 Gwendal Le Bihan"
